...
@push('customjs')
    ...
    <script type="text/javascript">
        ...
        $(document).on('click',".eliminar",function(){
            $("#product_name").text($(this).find('.product').val());
...
@section('content')
            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="col-lg-12 text-center">
                            ¿Estás seguro que quieres eliminar el producto <b id="product_name"></b>?
                        </div>
                    </div>
    ...
    <div class="panel panel-inverse">
        <div class="panel-heading">
            <h4 class="panel-title">Productos del sistema</h4>
            <div class="panel-heading-btn">
                <a href="{{ route('productos.create') }}" class="btn btn-indigo btn-sm"><i class="fas fa-plus-circle"></i>&nbsp; Agregar producto</a>&nbsp;&nbsp;&nbsp;&nbsp;

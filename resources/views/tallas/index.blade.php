...
@push('customjs')
    ...
    <script>
        ...
        $(document).on('click',".eliminar",function(){
            $("#talla_name").text($(this).find('.talla').val());
...
@section('content')
        ...
        <form id="modal-form" method="post">
            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    ...
                    <h5 class="modal-title" id="delModalLabel">¿Eliminar talla?</h5>
                    ...
                    <div class="modal-body">
                        ...
                        <div class="col-lg-12 text-center">
                            ¿Estás seguro que quieres eliminar el talla <b id="talla_name"></b>?
                        </div>
                    </div>
    ...
    <div class="panel panel-inverse">
        <div class="panel-heading">
            <h4 class="panel-title">Tallas del sistema</h4>
            <div class="panel-heading-btn">
                <a href="{{ route('tallas.create') }}" class="btn btn-indigo btn-sm"><i class="fas fa-plus-circle"></i>&nbsp; Agregar talla</a>&nbsp;&nbsp;&nbsp;&nbsp;
